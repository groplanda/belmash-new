...
mix.setPublicPath('./themes/belmash/assets');
mix.js('./themes/belmash/assets/src/app.js', 'dist/js')
  .sass('./themes/belmash/assets/src/app.scss', 'dist/css')
  .options({
  ...
  .browserSync({
    ...
    notify: false,
    files: [
      "./themes/belmash/assets/dist/css/*.css",
      "./themes/belmash/assets/dist/js/*.js",
      "./themes/belmash/**/*.htm",
    ]
});
